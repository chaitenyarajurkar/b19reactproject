...
function App() {
  ...
  const [dropDowndata , setDropDowndata] = useState(["Male","Female","other"]);
  const [newDropdown, setNewDropdown] = useState([{code:"Male",value:"M"},{code:"Female",value:"F"},{code:"Other",value:"O"}
                                                  ]);
          ...
          <div className='col-4 border border-primary p-3 shadow p-3 mb-5 bg-white  m-3 ' style={{height:"500px",overflow:"auto"}}>
            ...
            {/* <div className="mb-3">
              ...
              {/* <div className="mb-3">
                <label className="form-label">Gender</label>
                <select className="form-select" aria-label="Default select example" value={formData.gender} onChange={(e) => commmonHandler("gender", e)}>
                <option defaultValue={dropDowndata[1]}>{dropDowndata[1]}</option>
              ...
              {/* dropdown via array of objs */}
              <div className="mb-3">
                <label className="form-label">Gender</label>
                <select className="form-select" aria-label="Default select example" value={formData.gender} onChange={(e) => commmonHandler("gender", e)}>
                {/* <option defaultValue={newDropdown[1].value}>{newDropdown[1].code}</option> */}
                     {newDropdown.map((val)=>{

                             return(
                              <option value={val.value}>{val.code}</option>
                             )
                     })}
                </select>
